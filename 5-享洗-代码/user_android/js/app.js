...
(function($, owner) {
	...
	owner.login = function(loginInfo, callback) {
		...
		mui.ajax('http://180.76.233.59:82/user/login',{
				data:{
	...
	owner.reg = function(regInfo, callback) {
		...
		mui.ajax('http://180.76.233.59:82/user/register',{
				data:{
	...
	owner.uploadImage=function(data){
		mui.ajax('http://180.76.233.59:82/user/info/avatar',{
				data:{
					id:app.getState().uid,
					avatar:data
				},
	...
	image1.onload =function(){
		app.uploadImage(app.getBase64Image(image1));
	}
